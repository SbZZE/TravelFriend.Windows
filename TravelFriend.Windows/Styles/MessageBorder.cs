...
namespace TravelFriend.Windows.Styles
{
    public sealed class MessageBorder : Decorator
    {
        ...
        public static readonly DependencyProperty PlacementProperty =
            DependencyProperty.Register("Placement", typeof(EnumPlacement), typeof(MessageBorder),
        ...
        public static readonly DependencyProperty TailWidthProperty =
            DependencyProperty.Register("TailWidth", typeof(double), typeof(MessageBorder), new PropertyMetadata(10d));
        /// <summary>
        /// 尾巴的宽度，默认值为7
        /// </summary>
        ...
        public static readonly DependencyProperty TailHeightProperty =
            DependencyProperty.Register("TailHeight", typeof(double), typeof(MessageBorder), new PropertyMetadata(10d));
        /// <summary>
        /// 尾巴的高度，默认值为10
        /// </summary>
        ...
        public static readonly DependencyProperty TailVerticalOffsetProperty =
            DependencyProperty.Register("TailVerticalOffset", typeof(double), typeof(MessageBorder), new PropertyMetadata(13d));
        /// <summary>
        /// 尾巴距离顶部的距离，默认值为10
        /// </summary>
        ...
        public static readonly DependencyProperty TailHorizontalOffsetProperty =
            DependencyProperty.Register("TailHorizontalOffset", typeof(double), typeof(MessageBorder),
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.Register("Background", typeof(Brush), typeof(MessageBorder)
        ...
        public static readonly DependencyProperty PaddingProperty =
            DependencyProperty.Register("Padding", typeof(Thickness), typeof(MessageBorder)
        ...
        public static readonly DependencyProperty BorderBrushProperty =
            DependencyProperty.Register("BorderBrush", typeof(Brush), typeof(MessageBorder)
        ...
        public static readonly DependencyProperty BorderThicknessProperty =
            DependencyProperty.Register("BorderThickness", typeof(Thickness), typeof(MessageBorder), new PropertyMetadata(new Thickness(1d)));
        /// <summary>
        /// 边框大小
        /// </summary>
        ...
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register("CornerRadius", typeof(System.Windows.CornerRadius)
                , typeof(MessageBorder), new PropertyMetadata(new CornerRadius(0)));
        /// <summary>
        /// 边框大小
        /// </summary>
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            if (Child != null)
            {
                ...
                pen.Thickness = MessageBorder.RoundLayoutValue(BorderThickness.Left, DoubleUtil.DpiScaleX);
        ...
        {
            double num;
            if (!MessageBorder.AreClose(dpiScale, 1.0))
            {
                num = Math.Round(value * dpiScale) / dpiScale;
                if (double.IsInfinity(num) || MessageBorder.AreClose(num, 1.7976931348623157E+308))
                {
                    num = value;
                }
            }
